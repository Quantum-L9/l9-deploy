...
├── ansible/playbooks/configure-memory.yml
...
├── ansible/roles/redis/templates/users.acl.j2
├── ansible/roles/runner_tooling/tasks/main.yml
├── ansible/roles/sqlite_backup/files/l9-sqlite-backup
├── ansible/roles/sqlite_backup/files/l9-sqlite-restore-test
├── ansible/roles/sqlite_backup/files/l9-sqlite-verify
├── ansible/roles/sqlite_backup/tasks/main.yml
...
├── artifacts/l9-contracts/l9/finding-bundle.json
├── artifacts/l9-contracts/raw/semgrep/report.json
├── checksums.sha256
...
├── pyproject.toml
├── release-work/handoffs/l9-provisioning-handoff/PREFLIGHT_CHECKLIST.md
├── release-work/handoffs/l9-provisioning-handoff/README.md
├── release-work/handoffs/l9-provisioning-handoff/RUNBOOK.md
├── release-work/handoffs/l9-provisioning-handoff/config-changes/CONFIG_CHANGES.md
├── release-work/handoffs/l9-provisioning-handoff/graphiti-image/Dockerfile
├── release-work/handoffs/l9-provisioning-handoff/graphiti-image/README.md
├── release-work/handoffs/l9-provisioning-handoff/graphiti-image/publish-image.yml
├── release-work/handoffs/l9-provisioning-handoff/secrets/.env.example
├── release-work/handoffs/l9-provisioning-handoff/secrets/REQUIRED_SECRETS.md
...
├── tests/unit/test_backup_verification.py
